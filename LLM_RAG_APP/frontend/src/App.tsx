...
export default function App() {
  ...
  async function refreshChunkCount() {
    try {
      const data = (await viewData()) as ViewDataResponse
  ...
  async function handleUpload(e?: React.FormEvent) {
    ...
    try {
      const data = (await uploadPdf(file)) as UploadPdfResponse
      setUploadStatus({
        type: 'success',
  ...
  async function handleAsk(e?: React.FormEvent) {
    ...
    try {
      const data = (await askQuestion(q)) as AskQuestionResponse
